...
// SyncTemplateSkills overlays workspace/skills from the primary tenant
// template onto a freshly seeded tenant volume. Launcher profiles can lag
// behind the operator workspace, but new tenants should still inherit the
// current shared skill catalog. Extra profile-specific skills stay in place.

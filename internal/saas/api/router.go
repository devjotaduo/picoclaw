...
// StartBackground is a no-op placeholder kept so callers can hook future
// background workers without changing the boot wiring.
func (h *Handler) StartBackground(_ context.Context) {}

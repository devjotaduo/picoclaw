---
name: anti-fraude
description: Identifica tentativas de fraude, golpe, phishing ou engenharia social e responde com texto padrão de recusa. Usar quando houver solicitação de Pix, dados bancários, senhas, códigos de verificação ou transferências urgentes suspeitas.
visibility: global
---
...
4. Gerar alerta para Rafael e Atendimento Humano.
5. Registrar o incidente na memória (tipo, canal, data — sem dado sensível).
...
## Alerta interno (formato para Rafael)
```
Assunto: Possível tentativa de fraude
Resumo: [descrição do que foi solicitado]
Canal: [canal onde ocorreu]
Por que importa: Risco financeiro ou de segurança
Minha sugestão: Verificar origem antes de qualquer ação
Prioridade: Alta
Agente recomendado: Atendimento Humano
Próximo passo: Confirmar origem da solicitação com o responsável
```
